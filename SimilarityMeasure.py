...
class SimilarityMeasure:
    ...
    def jaccardSim(self):
        ...
        df_user_x=pd.merge(df_user_pref_count,df_users_intersection_count,left_on='user_id',right_on='user_id_x').rename(columns={'pref_count':'pref_count_user_x'})[['pref_count_user_x','user_id_x','user_id_y','intersection_count']]
